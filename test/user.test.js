    ...
    request(app)
      ...
      .end(function (err, res) {
        ...
        expect(res.body.errors).toEqual(
          expect.arrayContaining(['"email" is not allowed to be empty'])
        );
        done();
      });
  });
  ...
  test("Fail because email has wrong input type", (done) => {
    request(app)
      ...
      .end(function (err, res) {
        ...
        expect(res.body).toHaveProperty("errors", expect.any(Array));
        expect(res.body.errors).toEqual(
          expect.arrayContaining(['"email" must be a string'])
        );
        done();
      });
  });
  ...
  test("Fail because name is undefined", (done) => {
    request(app)
      ...
      .end(function (err, res) {
        ...
        expect(res.body).toHaveProperty("errors", expect.any(Array));
        expect(res.body.errors).toEqual(
          expect.arrayContaining(['"name" is not allowed to be empty'])
        );
        done();
      });
  });
  ...
  test("Fail because password is undefined", (done) => {
    request(app)
      ...
      .end(function (err, res) {
        ...
        expect(res.body).toHaveProperty("errors", expect.any(Array));
        expect(res.body.errors).toEqual(
          expect.arrayContaining(['"password" is not allowed to be empty'])
        );
        done();
      });
  });
